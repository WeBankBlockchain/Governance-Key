...
public class MnemonicTestVectorsTests {
    ...
    public MnemonicTestVectorsTests(String entrophy, String expected) {
    ...
    public void testVectors(){
        String mnemonic = new PkeyByMnemonicService().createMnemonic(entrophy);
        Assert.assertTrue(Objects.equals(mnemonic, expected));
    }
